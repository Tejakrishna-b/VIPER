...
const GITHUB_CLIENT_ID = 'YOUR_GITHUB_CLIENT_ID';        // From GitHub OAuth App
const GITHUB_CLIENT_SECRET = 'YOUR_GITHUB_CLIENT_SECRET'; // From GitHub OAuth App
const ALLOWED_ORIGIN = 'https://Tejakrishna-b.github.io'; // Your GitHub Pages URL (no trailing slash)
